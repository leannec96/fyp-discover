		...
		/**
            ...
            <ul id="test-questions">
                ...
                <li>
                    ...
                    <h3>Being in a crowd doesn't bother me</h3></h3>
                ...
                <li>
                    <div class="quiz-overlay"></div>
                    <h3>In my free time, I enjoy doing things with friends, as opposed to 'me' time</h3>
                ...
                <li>
                    <div class="quiz-overlay"></div>
                    <h3>I find it easier to have a conversation with one person as opposed to a group</h3>
                ...
                <li>
                    <div class="quiz-overlay"></div>
                    <h3>I am fast at reacting to an unexpected situation i.e. a plate falling from a counter</h3>
                ...
                <li>
                    <div class="quiz-overlay"></div>
                    <h3>I don't mind working out maths problems and solving for 'x'</h3>
