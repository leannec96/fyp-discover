    ...
    <div id="content" class="clearfix">
            <ul id="test-questions">
                ...
                <li>
                    ...
                    <h3>Crowds don't phase me. I actually enjoy bigger groups!</h3>
                ...
                <li>
                    <div class="quiz-overlay"></div>
                    <h3>When I have free time, I prefer to socialise than be alone</h3>
                ...
                <li>
                    <div class="quiz-overlay"></div>
                    <h3>I find it easier to communicate one on one than to a number of people</h3>
                ...
                <li>
                    <div class="quiz-overlay"></div>
                    <h3>I can quickly adapt to new surroundings</h3>
